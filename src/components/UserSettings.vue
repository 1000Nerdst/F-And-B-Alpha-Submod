<template>
    <v-container>
        ...
        <v-row>
            <v-card
            max-height="64">
                <v-card-text>Energy Target &emsp;&emsp;&emsp;&emsp;{{ targetCalories }}&emsp;Maintenance Target &emsp;&emsp;&emsp;&emsp;{{ maintenceCalories }}</v-card-text>
            </v-card>
        </v-row>
                ...
                <v-card>
                    <v-list>
                        ...
                        >
                            ...
                            <div v-if="option.formType === 'selects' && option.text === 'Active Days Per Week'">
                                <v-select
                            ...
                            <div v-if="option.formType === 'selects' && option.text === 'Gender'">
                                <v-select
                            ...
                            <div v-if="option.formType === 'selects' && option.text === 'Goal'">
                                <v-select
                                v-model="selectGoal"
                                :items="goals"
                                menu-prop="auto"
                            ...
                            <div v-if="option.formType === 'button' && option.text === 'Update Settings'">
